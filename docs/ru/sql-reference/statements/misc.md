...
При удалении роль отзывается у всех объектов доступа, которым она присвоена.
...
При удалении политика отзывается у всех объектов доступа, которым она присвоена.
...
При удалении квота отзывается у всех объектов доступа, которым она присвоена.
...
При удалении профиль отзывается у всех объектов доступа, которым она присвоена.
...
Устанавливает пользователю роли по умолчанию.

Роли по умолчанию активируется по умолчанию при входе пользователя. Ролями по умолчанию могут быть установлены только ранее назначенные роли. Если роль не назначена пользователю, ClickHouse кидает исключение.
